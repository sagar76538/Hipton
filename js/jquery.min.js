...
function openProductDetails(divId)
{
    console.log("reached");
    // $("#main_section").hide();
    $("#productDetail").show();
    var image = document.getElementById("productImage");
    image.src="products/"+divId;
    var productName = divId.split("/")[1];

    if(productName=="bulletplus.jpg")
    {
        var product = document.getElementById("productName");
        product.textContent=productName.split(".")[0];
    }


/// write more else if  here for every product
